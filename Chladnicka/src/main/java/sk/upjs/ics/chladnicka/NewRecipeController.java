...
public class NewRecipeController{
    ...
    void addToRecipe(ActionEvent event) {
        ...
        //RecipeHasIngredient recipeHas = new RecipeHasIngredient(ingredient_id, Long.valueOf(2), amount);
        //recipeHasIngredientDao.save(recipeHas);
        // clear already used fields
        measureComboBox.getSelectionModel().selectFirst();
        ingredientComboBox.getSelectionModel().selectFirst();
        quantityField.clear();
